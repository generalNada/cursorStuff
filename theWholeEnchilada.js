...
'DOUGH', 'DOWEL', 'DOWNY', 'DOWRY', 'DOZEN', 'DRAFT', 'DRAIN', 'DRAKE', 
'DRANK', 'DRAPE', 'DRAWL', 'DRAWN', 'DREAD', 'DREAM', 'DRESS', 'DRIED', 'DRIER', 'DRIFT',
'DRILL', 'DRINK', 'DRIVE', 'DROIT', 'DROLL', 'DRONE', 'DROOL', 'DROOP', 'DROSS', 'DROVE',
...
'STING', 'STINK', 'STINT', 'STOCK', 'STOIC', 'STOKE', 'STOLE', 'STOMP', 'STONE', 'STONY',
'STOOD', 'STOOL', 'STOOP', 'STORE', 'STORK', 'STORM', 'STORY', 'STOUT', 'STOVE', 'STRAP',
'STRAW', 'STRAY', 'STRIP', 'STRUT', 'STUCK', 'STUDY', 'STUMP', 'STUNG', 'STUNK',
'STUNT', 'STYLE', 'SUAVE', 'SUEDE', 'SUGAR', 'SUING', 'SUITE', 'SULKY', 'SULLY', 'SUMAC',
...
export const dailyWordsLarge = [
    ...
    'DOTES', 'DOTTY', 'DOUAR', 'DOUBT', 'DOUCE', 'DOUCS', 'DOUGH', 'DOUKS', 'DOULA', 'DOUMA',
    'DOUMS', 'DOUPS', 'DOURA', 'DOUSE', 'DOUTS', 'DOVED', 'DOVEN', 'DOVER', 'DOVES', 'DOVIE',
    'DOWAR', 'DOWDS', 'DOWED', 'DOWEL', 'DOWER', 'DOWIE', 'DOWLE', 'DOWLS', 'DOWLY',
    'DOWNA', 'DOWNS', 'DOWNY', 'DOWPS', 'DOWRY', 'DOWSE', 'DOWTS', 'DOXED', 'DOXES', 'DOXIE',
    'DOYEN', 'DOYLY', 'DOZED', 'DOZEN', 'DOZER', 'DOZES', 'DRABS', 'DRACK', 'DRACO', 'DRAFF',
    ...
    'DUNNY', 'DUNSH', 'DUNTS', 'DUOMI', 'DUOMO', 'DUPED', 'DUPER', 'DUPES', 'DUPLE', 'DUPLY',
    'DUPPY', 'DURAL', 'DURAS', 'DURED', 'DURES', 'DURGY', 'DURNS', 'DUROC', 'DUROS', 'DUROY',
    'DURRA', 'DURRS', 'DURRY', 'DURST', 'DURUM', 'DURZI', 'DUSKS', 'DUSKY', 'DUSTS', 
    'DUTCH', 'DUVET', 'DUXES', 'DWAAL', 'DWALE', 'DWALM', 'DWAMS', 'DWANG', 'DWARF', 'DWAUM',
    'DWEEB', 'DWELL', 'DWELT', 'DWILE', 'DWINE', 'DYADS', 'DYERS', 'DYING', 'DYKED', 'DYKES',
    'DYKON', 'DYNEL', 'DYNES', 'EAGER', 'EAGLE', 'EAGRE', 'EALED', 'EALES', 'EANED', 'EARDS',
    'EARED', 'EARLS', 'EARLY', 'EARNS', 'EARNT', 'EARST', 'EARTH', 'EASED', 'EASEL', 'EASER',
    ...
    'LISLE', 'LISPS', 'LISTS', 'LITAI', 'LITAS', 'LITED', 'LITER', 'LITES', 'LITHE', 'LITHO',
    'LITHS', 'LITRE', 'LIVED', 'LIVEN', 'LIVER', 'LIVES', 'LIVID', 'LIVOR', 'LIVRE', 'LLAMA',
    'LLANO', 'LOACH', 'LOADS', 'LOAFS', 'LOAMS', 'LOAMY', 'LOANS', 'LOAST', 'LOAVE',
    ...
    'SARED', 'SAREE', 'SARGE', 'SARGO', 'SARIN', 'SARIS', 'SARKS', 'SARKY', 'SAROD', 'SAROS',
    'SARUS', 'SASER', 'SASIN', 'SASSE', 'SASSY', 'SATAI', 'SATAY', 'SATED', 'SATEM', 'SATES',
    'SATIS', 'SATYR', 'SAUBA', 'SAUCE', 'SAUCH', 'SAUCY', 'SAUGH', 'SAULS', 'SAULT',
    'SAUNA', 'SAUNT', 'SAURY', 'SAUTE', 'SAUTS', 'SAVED', 'SAVER', 'SAVES', 'SAVEY', 'SAVIN',
    'SAVOR', 'SAVOY', 'SAVVY', 'SAWAH', 'SAWED', 'SAWER', 'SAXES', 'SAYED', 'SAYER', 'SAYID',
    'SAYNE', 'SAYON', 'SAYST', 'SAZES', 'SCABS', 'SCADS', 'SCAFF', 'SCAGS', 'SCAIL', 'SCALA',
    'SCALD', 'SCALE', 'SCALL', 'SCALP', 'SCALY', 'SCAMP', 'SCAMS', 'SCAND', 'SCANS', 'SCANT',
    ...
    'STOWP', 'STOWS', 'STRAD', 'STRAE', 'STRAG', 'STRAK', 'STRAP', 'STRAW', 'STRAY', 'STREP',
    'STREW', 'STRIA', 'STRIG', 'STRIM', 'STRIP', 'STROP', 'STROW', 'STROY', 'STRUM', 'STRUT',
    'STUBS', 'STUCK', 'STUDE', 'STUDS', 'STUDY', 'STULL', 'STULM', 'STUMM', 'STUMP',
    'STUMS', 'STUNG', 'STUNK', 'STUNS', 'STUNT', 'STUPA', 'STUPE', 'STURE', 'STURT', 'STYED',
    'STYES', 'STYLE', 'STYLI', 'STYLO', 'STYME', 'STYMY', 'STYRE', 'STYTE', 'SUAVE', 'SUBAH',
    'SUBAS', 'SUBBY', 'SUBER', 'SUBHA', 'SUCCI', 'SUCKS', 'SUCKY', 'SUCRE', 'SUDDS', 'SUDOR',
    'SUDSY', 'SUEDE', 'SUENT', 'SUERS', 'SUETE', 'SUETS', 'SUETY', 'SUGAN', 'SUGAR', 'SUGHS',
    ...
    'WAREZ', 'WARKS', 'WARMS', 'WARNS', 'WARPS', 'WARRE', 'WARST', 'WARTS', 'WARTY', 'WASES',
    'WASHY', 'WASMS', 'WASPS', 'WASPY', 'WASTE', 'WASTS', 'WATAP', 'WATCH', 'WATER', 'WATTS',
    'WAUFF', 'WAUGH', 'WAUKS', 'WAULK', 'WAULS', 'WAURS', 'WAVED', 'WAVES', 'WAVEY',
    'WAWAS', 'WAWES', 'WAWLS', 'WAXED', 'WAXEN', 'WAXER', 'WAXES', 'WAYED', 'WAZIR', 'WAZOO',
