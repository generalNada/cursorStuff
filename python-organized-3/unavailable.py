my_list = {
    ...
    'CRIMP', 'CRISP', 'CROAK', 'CRONE', 'CROOK', 'CROSS', 'CROWD', 'CROWN', 'CRUMB', 'CRUSH',
    ...
    'LINGO',
    'LITHE', 'LIVER', 'LIVID', 'LLAMA', 'LOBBY', 'LOCAL', 'LOCUS', 'LOFTY', 'LOGIC', 'LOOPY', 
    'LORIS',
    ...
    'SNARL', 'SNEAK', 'SNIDE', 'SNOOP', 'SNORT', 'SNOUT', 'SOBER', 'SOGGY', 'SOLAR', 'SOLID', 
    'SOLVE',
